		...
		<CheckboxGroup>
			...
			<FormControl>
				<Checkbox
					...
					value={layers.added}
					onChange={(e) =>
						onChange({ ...layers, added: e.target.checked ? "true" : "false" })
					}
				/>
			...
			<FormControl sx={{ marginTop: "10px" }}>
				<Checkbox
					...
					onChange={(e) =>
						onChange({
							...layers,
							removed: e.target.checked ? "true" : "false",
						})
					}
				/>
			...
			<FormControl sx={{ marginTop: "10px" }}>
				<Checkbox
					...
					onChange={(e) =>
						onChange({
							...layers,
							layoutChanged: e.target.checked ? "true" : "false",
						})
					}
				/>
			...
			<FormControl sx={{ marginTop: "10px" }}>
				<Checkbox
					...
					onChange={(e) =>
						onChange({
							...layers,
							attributesChanged: e.target.checked ? "true" : "false",
						})
					}
				/>
