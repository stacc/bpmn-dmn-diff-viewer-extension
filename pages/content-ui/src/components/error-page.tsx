...
export function ErrorPage({ elements, colorMode, message, docs }: ErrorPageProps): React.ReactElement {
  return (
    <ThemeProvider colorMode={colorMode}>
      {elements.map(element => (
        <ErrorPortal key={element.tagName} element={element} message={message} docs={docs} />
      ))}
    </ThemeProvider>
  );
}
